...
class ComponentsControllerTest < ActionController::TestCase
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post :create, component: { automated_test_id: @component.automated_test_id, description: @component.description, name: @component.name, type: @component.type }
    end
  ...
  test "should update component" do
    patch :update, id: @component, component: { automated_test_id: @component.automated_test_id, description: @component.description, name: @component.name, type: @component.type }
    assert_redirected_to component_path(assigns(:component))
  end
